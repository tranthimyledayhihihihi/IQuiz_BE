...
(4, 3,
 ...
 NULL)
 (5, 1,
 N'Ngô Quyền', N'Lý Thường Kiệt', N'Trần Hưng Đạo', N'Lê Lợi',
 N'A', 1, NULL,
 '2025-12-01T20:30:00.0000000',
 N'Ai là người lãnh đạo chiến thắng Bạch Đằng năm 938?',
 NULL),

(6, 1,
 N'1945', N'1954', N'1975', N'1968',
 N'A', 1, NULL,
 '2025-12-01T20:30:00.0000001',
 N'Cách mạng tháng Tám thành công năm nào?',
 NULL),

(7, 2,
 N'5', N'7', N'9', N'11',
 N'B', 1, NULL,
 '2025-12-01T20:30:00.0000002',
 N'Số nguyên tố nhỏ nhất lớn hơn 5 là số nào?',
 NULL),

(8, 2,
 N'12', N'24', N'36', N'48',
 N'B', 1, NULL,
 '2025-12-01T20:30:00.0000003',
 N'Ước chung lớn nhất của 24 và 48 là bao nhiêu?',
 NULL),

(9, 3,
 N'Oxy', N'Hydro', N'Nitơ', N'Carbon',
 N'B', 1, NULL,
 '2025-12-01T20:30:00.0000004',
 N'Nguyên tố hóa học nhẹ nhất là gì?',
 NULL),

(10, 3,
 N'H2O', N'CO2', N'O2', N'NaCl',
 N'A', 1, NULL,
 '2025-12-01T20:30:00.0000005',
 N'Công thức hóa học của nước là gì?',
 NULL),

(11, 4,
 N'Java', N'Kotlin', N'C#', N'Swift',
 N'B', 1, NULL,
 '2025-12-01T20:30:00.0000006',
 N'Ngôn ngữ chính thức ưu tiên cho Android hiện nay là gì?',
 NULL),

(12, 4,
 N'Activity', N'Service', N'BroadcastReceiver', N'ContentProvider',
 N'A', 1, NULL,
 '2025-12-01T20:30:00.0000007',
 N'Thành phần nào chịu trách nhiệm hiển thị UI trong Android?',
 NULL),

(13, 4,
 N'SQL Server', N'MySQL', N'PostgreSQL', N'Firebase',
 N'D', 1, NULL,
 '2025-12-01T20:30:00.0000008',
 N'Cơ sở dữ liệu NoSQL phổ biến cho mobile app là gì?',
 NULL),

(14, 5,
 N'GET', N'POST', N'PUT', N'DELETE',
 N'A', 1, NULL,
 '2025-12-01T20:30:00.0000009',
 N'HTTP method nào dùng để lấy dữ liệu?',
 NULL),

(15, 5,
 N'200', N'401', N'404', N'500',
 N'C', 1, NULL,
 '2025-12-01T20:30:00.0000010',
 N'Mã trạng thái HTTP nào biểu thị không tìm thấy tài nguyên?',
 NULL),

(16, 5,
 N'Client', N'Server', N'Database', N'Cache',
 N'B', 1, NULL,
 '2025-12-01T20:30:00.0000011',
 N'Thành phần nào xử lý logic chính của ứng dụng web?',
 NULL),

(17, 6,
 N'RAM', N'CPU', N'GPU', N'SSD',
 N'B', 1, NULL,
 '2025-12-01T20:30:00.0000012',
 N'Bộ phận nào chịu trách nhiệm xử lý tính toán chính?',
 NULL),

(18, 6,
 N'Input', N'Process', N'Output', N'Storage',
 N'B', 1, NULL,
 '2025-12-01T20:30:00.0000013',
 N'Bước nào xử lý dữ liệu trong mô hình IPO?',
 NULL),

(19, 6,
 N'Bit', N'Byte', N'KB', N'MB',
 N'A', 1, NULL,
 '2025-12-01T20:30:00.0000014',
 N'Đơn vị dữ liệu nhỏ nhất trong máy tính là gì?',
 NULL),

(20, 7,
 N'Git', N'SVN', N'Mercurial', N'Perforce',
 N'A', 1, NULL,
 '2025-12-01T20:30:00.0000015',
 N'Hệ thống quản lý mã nguồn phổ biến nhất hiện nay là gì?',
 NULL),

(21, 7,
 N'commit', N'push', N'pull', N'merge',
 N'A', 1, NULL,
 '2025-12-01T20:30:00.0000016',
 N'Lệnh Git nào dùng để lưu thay đổi cục bộ?',
 NULL),

(22, 7,
 N'Frontend', N'Backend', N'API', N'Database',
 N'C', 1, NULL,
 '2025-12-01T20:30:00.0000017',
 N'Thành phần nào giúp frontend và backend giao tiếp?',
 NULL),

(23, 8,
 N'TCP', N'UDP', N'HTTP', N'FTP',
 N'A', 1, NULL,
 '2025-12-01T20:30:00.0000018',
 N'Giao thức nào đảm bảo truyền dữ liệu tin cậy?',
 NULL),

(24, 8,
 N'Client-server', N'Peer-to-peer', N'Master-slave', N'MVC',
 N'A', 1, NULL,
 '2025-12-01T20:30:00.0000019',
 N'Mô hình mạng phổ biến của ứng dụng web là gì?',
 NULL);
